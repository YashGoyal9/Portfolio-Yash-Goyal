...
// cricket,designning,music ,poetry
const content = [
  {
    title: "Designing",
    description:
  ...
  },
  {
    title: "Cricket",
    description:
"I have a keen interest in playing cricket, and he, the legend, is my inspiration. His leadership and skill always help me to improve my life.",
    content: (
        <div className="h-full w-full  flex items-center justify-center text-white">
       <Link href="https://www.instagram.com/mahi7781?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" passHref>
       <Image
          src="/assessts/msd.jpg"
          width={300}
          height={300}
          className="h-full w-full object-cover"
          alt="linear board demo3"
        />
       </Link>
      </div>
    ),
  },
  {
    ...
    content: (
        <div className="h-full w-full  flex items-center justify-center text-white">
        <Link href="https://www.instagram.com/yahyabootwala?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" passHref>
        <Image
          src="/assessts/poetry.png"
          width={300}
          height={400}
          className="h-full w-full object-cover"
          alt="linear board demo4"
        />
        </Link>
      </div>
    ),
